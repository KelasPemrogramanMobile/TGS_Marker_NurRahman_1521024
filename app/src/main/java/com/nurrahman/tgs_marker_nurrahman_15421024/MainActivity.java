package com.nurrahman.tgs_marker_nurrahman_15421024;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.invalidate();
        startMarker.setIcon(getResources().getDrawable(R.drawable.ico5));
        ...
        GeoPoint startPoint5 = new GeoPoint(-5.377093, 105.254496);
